...
do
	echo "netperf -L 192.168.0.11 -H ${gigabit} -t omni -- -T udp -d rr -r ${tsize},${tsize} -O "MEAN_LATENCY, MAX_LATENCY, MIN_LATENCY, P99_LATENCY, P90_LATENCY, P50_LATENCY, STDDEV_LATENCY, THROUGHPUT, THROUGHPUT_UNITS""
